...
public class DrillCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drills.add(new Drill(getString(R.string.drill_interskol_tatle),getString(R.string.drill_interskol_info),R.drawable.interskol));
        drills.add(new Drill(getString(R.string.drill_makita_tatle),getString(R.string.drill_makita_info),R.drawable.makita));
        drills.add(new Drill(getString(R.string.drill_dewalt_tatle),getString(R.string.drill_dewalt_info),R.drawable.dewalt));
